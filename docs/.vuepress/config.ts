...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        link: '/zaqizaba/',
        items: [
          { text: '文档编写规范', link: '/docsDemo/' },
          { text: '我用过的电脑', link: '/usedcomputers/' },
          { text: '喷涂相关', link: '/buwuzhengye/' },
          { text: '每日一溜', link: '/liubing/' },
        ],
      },
      { text: '关于', link: '/about/' },
      {
    ...
    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://www.xiaoliutalk.cn/img/favicon.ico',
      name: '小刘说',
      slogan: '砥砺前行',
    },
  ...
  plugins: <UserPlugins>[
    ...
    [
      'vuepress-plugin-mathjax', // 数学公式转换
      {
        target: 'chtml'
      }
    ],
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        ...
        options: {
          ...
          createIssueManually: false, // 是否允许手动创建 GitHub issue
