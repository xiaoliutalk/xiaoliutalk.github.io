...
![shutdown](https://xiaoliutalk.gitee.io/img/shutdown.jpg)
常用：
...
### 2.1 pwd：显示当前目录
![pwd](https://xiaoliutalk.gitee.io/img/pwd.jpg)

### 2.2 cd:切换目录
![cd](https://xiaoliutalk.gitee.io/img/cd.jpg)

### 2.3 tree:树形显示目录
![tree](https://xiaoliutalk.gitee.io/img/tree.jpg)

### 2.4 mkdir：创建目录
![mkdir](https://xiaoliutalk.gitee.io/img/mkdir.jpg)
...
![touch](https://xiaoliutalk.gitee.io/img/touch.jpg)
...
![ls-1](https://xiaoliutalk.gitee.io/img/ls-1.jpg)
 ![ls-2](https://xiaoliutalk.gitee.io/img/ls-2.jpg)
...
### 2.7 cp:复制文件/目录
![cp](https://xiaoliutalk.gitee.io/img/cp.jpg)
...
### 2.8  mv：移动/重命名文件
![mv](https://xiaoliutalk.gitee.io/img/mv.jpg)

### 2.9 rm：删除文件或目录
![rm](https://xiaoliutalk.gitee.io/img/rm.jpg)

### 2.10 rmdir：删除空目录
![rmdir](https://xiaoliutalk.gitee.io/img/rmdir.jpg)
...
![ln](https://xiaoliutalk.gitee.io/img/ln.jpg)

### 2.12 find:查找文件
find语法使用说明：
![find-1](https://xiaoliutalk.gitee.io/img/find-1.jpg)
![find-2](https://xiaoliutalk.gitee.io/img/find-2.jpg)
![find-3](https://xiaoliutalk.gitee.io/img/find-3.jpg)
...
![find-4](https://xiaoliutalk.gitee.io/img/find-4.jpg)
- **-4** 代表查找4天以内
- **4**  代表查找第4天
- **+4** 代表查找4天以前
...
xargs 一般是和管道一起使用。
![xargs](https://xiaoliutalk.gitee.io/img/xargs.png)
常用
...
![chattr](https://xiaoliutalk.gitee.io/img/chattr.jpg)
```bash
# lsattr test.txt 
-------------------- test.txt
# chattr +a test.txt
...
![lsattr](https://xiaoliutalk.gitee.io/img/lsattr.jpg)
...
![md5sum](https://xiaoliutalk.gitee.io/img/md5sum.jpg)
...
![chmod](https://xiaoliutalk.gitee.io/img/chmod.jpg)
